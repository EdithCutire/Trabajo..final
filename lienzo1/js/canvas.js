...
function movimientoimg2(){
	...
	if(numeroo7 >= 1024) {numeroo7=0}else{numeroo7+=2}

    for (var i = 0; i <= numeroo7; i+=204) {
	  
	    if (numeroo7>=i) {ubicacion7 =i}
    }
    if (numero7>=1024) {numero7=0} else {numero7+=2}

    	for (var a = 0; a <=numero7; a+=10) {
    		if(numero7>=a) {ubicacion71=a}
    	}

// por defecto para borrar el imagen
ctx.clearRect(ubicacion71,0,0,0);
...
ctx.drawImage(sprite2, ubicacion7,100,204,250,ubicacion71,300,300,300);
frame(movimientoimg2);
