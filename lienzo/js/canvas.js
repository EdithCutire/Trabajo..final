...
function movimientoimg1(){
	...
	if(numeroo6 >= 1024) {numeroo6=0}else{numeroo6+=2}

    for (var i = 0; i <= numeroo6; i+=128) {
	  
	    if (numeroo6>=i) {ubicacion6 =i}
    }
    if (numero6>=1024) {numero6=0} else {numero6+2}

    	for (var a = 0; a <=numero6; a+=10) {
    		if(numero6>=a) {ubicacion61=a}
    	}

// por defecto para borrar el imagen
ctx.clearRect(ubicacion61,0,0,0);
...
ctx.drawImage(sprite1, ubicacion6,100,128,250,ubicacion61,300,300,300);
frame(movimientoimg1);
